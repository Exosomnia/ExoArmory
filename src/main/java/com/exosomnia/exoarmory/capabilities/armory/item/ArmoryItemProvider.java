...
public class ArmoryItemProvider implements ICapabilitySerializable<CompoundTag> {
    ...
    private final LazyOptional<ArmoryItemStorage> instance;

    public ArmoryItemProvider() {
        this(null);
    }

    public ArmoryItemProvider(@Nullable CompoundTag tag) {
        instance = LazyOptional.of(() -> new ArmoryItemStorage(tag));
    }
